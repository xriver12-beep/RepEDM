            ...
            if (useRawImport) {
                ...
                const processSection = (contentObj, sectionName) => {
                    ...
                    if (contentObj.type === 'image') {
                        ...
                        return `<div class="${sectionName}" style="margin: 0; padding: 0; line-height: 0;"><img src="${contentObj.content}" style="width: 100%; display: block; border: 0;"></div>`;
                    } else {
                        // HTML Content
...
<div class="header" style="margin:0; padding:0; line-height:0;">
    <center>
        <table border="0" width="900" id="table9" cellspacing="0" cellpadding="0" style="margin:0; padding:0; border-collapse:collapse;">
            <tr>
                <td style="padding:0; margin:0; line-height:0;"><map name="FPMap0">
...
<body ${standardBodyAttrs}>
<div class="footer" style="margin:0; padding:0; line-height:0;">
    <center>
        <table border="0" width="900" id="table13" cellspacing="0" cellpadding="0" style="margin:0; padding:0; border-collapse:collapse;">
            ...
            <tr>
                <td bgcolor="#CCCCCC" style="padding:0; margin:0; line-height:0;">
